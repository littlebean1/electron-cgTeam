    ...
    <div>
            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <el-table :data="props.row.gridData" style="width: 100%" row-key="guid">
                        ...
                        <el-table-column prop="invokeUser" label="执行人"  min-width="15%"/>
                        <el-table-column prop="reviewUser" label="审验人"  min-width="15%"/>
        ...
        <el-dialog
            ...
            <el-form label-width="80px" label-position="left" >
                ...
                <el-form-item label="执行人">
                    <el-select v-model="editTask.invokeUser" placeholder="请选择">
                        <el-option v-for="item in invokeUserOptions" :key="item.value" :label="item.label" :value="item.value"/>
                    </el-select>
                </el-form-item>
                <el-form-item label="审验人">
                    <el-select v-model="editTask.reviewUser" placeholder="请选择">
                        <el-option v-for="item in reviewUserOptions" :key="item.value" :label="item.label" :value="item.value"/>
                    </el-select>
                </el-form-item>     
        ...
        <el-dialog
            ...
            <el-form label-width="60px" class="demo-ruleForm" label-position="left">
                ...
                <el-form-item label="执行人">
                    <el-select v-model="newTask.invokeUser" placeholder="请选择">
                        <el-option v-for="item in invokeUserOptions" :key="item.value" :label="item.label" :value="item.value"/>
                    </el-select>
                </el-form-item>
                <el-form-item label="审验人">
                    <el-select v-model="newTask.reviewUser" placeholder="请选择">
                        <el-option v-for="item in reviewUserOptions" :key="item.value" :label="item.label" :value="item.value"/>
                    </el-select>
                </el-form-item>     
                <el-form-item label="难度">
  ...
  export default {
    ...
    mounted() {
        ...
        this.getAllUsers().then(data => {
            ...
            this.reviewUserOptions = tempUsers
            this.invokeUserOptions = tempUsers
        })
    },
    methods: {
        getAllUsers() {
            ...
            if (this.file != null && this.file.length > 0) {
                ...
                axios.post(
                    "http://localhost:3000/api/asset/updateAssetTask", {
                        ...
                        "reviewUser": this.editTask.reviewUser,
                        "invokeUser": this.editTask.invokeUser,
        ...
        addTaskSuccessUp(response, file, fileList) {
            ...
            axios.post(
                "http://localhost:3000/api/asset/addTask", {
                    ...
                    "reviewUser": this.newTask.reviewUser,
                    "invokeUser": this.newTask.invokeUser,
